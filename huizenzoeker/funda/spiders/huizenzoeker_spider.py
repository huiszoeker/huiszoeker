...
class FundaSpider(CrawlSpider):
    ...
    def __init__(self, province='utrecht', place='utrecht'):
        self.start_urls = ["https://www.huizenzoeker.nl/huur/%s/%s/%s/?anbd=1" % (province, place, page_number) for page_number in range(1,2)]
